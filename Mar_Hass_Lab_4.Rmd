...
Checking the normal Q-Q plot, it looks like our errors are roughly normally distributed. The Q-Q plot isn't perfectly normal, but we can use the CLT to assume normality of errors.  
...
However, using the CLT, we can assume normality of errors.
